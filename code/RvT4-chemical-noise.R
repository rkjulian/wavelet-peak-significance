...
print_summary_plots <- function(instrument, peak_data) {
  ...
  peak_data_combined |>
    select(-prominence) |>
    write_csv(file.path("analysis", paste0("RvT4_peak_data_", instrument, ".csv")))
...
# Open PDF file
pdf(file.path("analysis", "RvT4_Chemical_Noise_Analysis.pdf"),
...
write(json_text, file = "RvT4_chemical_noise.json")
