...
# waters-noise-pooled.csv, Gabapentin Quant row):
blank_noise_mean <- 3936.716139
blank_noise_std <- 1364.6341667

# Load chemical noise statistics (from Gabapentin-quant-chemical-noise.R)
peak_data <- read_csv(
    file.path("results", "tables", "Gabapentin_quant_peak_data_waters.csv")
)
...
write(json_text, file = file.path("results", "json", "Gabapentin_quant_results.json"))
