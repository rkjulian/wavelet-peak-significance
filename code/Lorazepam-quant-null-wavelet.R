...
# waters-noise-pooled.csv, Lorazepam Quant row):
blank_noise_mean <- 125.86432359
blank_noise_std <- 460.91808872

# Load chemical noise statistics (from Lorazepam-quant-chemical-noise.R)
peak_data <- read_csv(
...
write(json_text, file = file.path("results", "json", "Lorazepam_quant_results.json"))
